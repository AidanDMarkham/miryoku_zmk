...
U_NP,              U_NP,              &trans,            &trans,            &trans,            &kp RET,           &trans,            &kp END,           U_NP,              U_NP

#define MIRYOKU_LAYER_NUM \
&kp PRCNT,         &kp N7,            &kp N8,            &kp N9,            &kp ASTRK ,        U_NA,              U_NA,              U_NA,              U_NA,              &kp LC(LA(DEL)),   \
&kp DOT,           &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         U_NA,              &sk LCTRL,         &sk LSHFT,         &sk LALT,          &sk LGUI,          \
&kp SLASH,         &kp N1,            &kp N2,            &kp N3,            &kp PLUS,          U_NA,              &kp BSPC,          U_NA,              U_NA,              &kp DEL,           \
U_NP,              U_NP,              &kp N0,            &trans,            &kp MINUS,         &trans,            &trans,            &trans,            U_NP,              U_NP

#define MIRYOKU_LAYER_SYM \
&kp EXCL,          &kp AMPS,          &kp AT,           &kp HASH,           &kp DLLR,          U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
&kp SEMI,          &kp LBRC,          &kp LBKT,         &kp LPAR,           &kp CARET,         U_NA,              &sk LCTRL,         &sk LSHFT,         &sk LALT,          &sk LGUI,          \
&kp GRAVE,         &kp RBRC,          &kp RBKT,         &kp RPAR,           &kp BSLH,          U_NA,              U_NA,              U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              &trans,           &trans,             &kp UNDER,         &trans,            &trans,            &trans,            U_NP,              U_NP

#define MIRYOKU_LAYER_FUN \
&kp F12,           &kp F7,            &kp F8,            &kp F9,            &kp PSCRN,         U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            \
